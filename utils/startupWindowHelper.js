...
function createStartupWindow(htmlContent, options = {}) {
    ...
    startupWindow.webContents.once('dom-ready', () => {
      ...
      document.body.style.cssText += '-webkit-clip-path: inset(0 round 12px);clip-path: inset(0 round 12px);border-radius: 12px;overflow: hidden;';
    `);
        startupWindow.show();
